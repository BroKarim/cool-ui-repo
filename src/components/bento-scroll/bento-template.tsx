...
const BentoCard = ({ name, className, background, description, href, cta }: { name: string; className: string; background: string; description: string; href: string; cta: string }) => (
  <div
    key={name}
    className={cn(
